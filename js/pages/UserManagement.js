            ...
            const mockUsers = [
                {
                    ...
                    accountLocked: false,
                    loginFailureCount: 0,
                    passwordExpiry: '2025-01-01',
                    permissions: ['user:manage', 'system:config', 'audit:view', 'association:manage', 'exhibition:manage', 'content:publish', 'operation:stats:view'],
                    importSource: 'manual',
                ...
                },
                {
                    id: 'U010',
                    key: 'U010',
                    username: 'union_admin_demo',
                    realName: '协会管理员',
                    phone: '18800000001',
                    email: 'unionadmin@demo.com',
                    ...
                    certification: 'verified',
                    securityLevel: 'high',
                    lastLogin: '2024-07-01 09:10:00',
                    loginCount: 888,
                    riskLevel: 'low',
                    registerTime: '2023-02-01 10:00:00',
                    twoFactorAuth: true,
                    accountLocked: false,
                    loginFailureCount: 0,
                    passwordExpiry: '2025-02-01',
                    permissions: ['association:manage', 'member:approve', 'policy:publish', 'content:publish', 'exhibition:manage', 'operation:stats:view'],
                    importSource: 'manual',
                ...
                },
                {
                    id: 'U011',
                    key: 'U011',
                    username: 'expo_admin_demo',
                    realName: '会展管理员',
                    phone: '18800000002',
                    email: 'expoadmin@demo.com',
                    userType: 'exhibition',
                    orgId: 'ORG004',
                    orgName: '北京国际会展公司',
                    status: 'active',
                    ...
                    permissions: ['exhibition:manage', 'content:publish', 'operation:stats:view'],
                    importSource: 'manual',
                    importTime: '2023-03-01 10:00:00'
                },
                {
                    id: 'U012',
                    key: 'U012',
                    ...
                    certification: 'verified',
                    securityLevel: 'medium',
                    lastLogin: '2024-07-01 09:30:00',
                    loginCount: 666,
                    riskLevel: 'low',
                    registerTime: '2023-04-01 10:00:00',
                    twoFactorAuth: true,
                    accountLocked: false,
                    loginFailureCount: 0,
                    passwordExpiry: '2025-04-01',
                    permissions: ['content:publish', 'operation:stats:view'],
                    importSource: 'manual',
                    importTime: '2023-04-01 10:00:00'
                },
                {
                    id: 'U013',
                    key: 'U013',
                    username: 'union_user_demo',
                    realName: '协会普通用户',
                    phone: '18800000004',
                    email: 'unionuser@demo.com',
                    userType: 'association',
                    orgId: 'ORG006',
                    orgName: '中国城市轨道交通协会',
                    status: 'active',
                ...
                },
                {
                    ...
                    securityLevel: 'low',
                    lastLogin: '2024-07-01 10:00:00',
                    loginCount: 333,
                    riskLevel: 'low',
                    registerTime: '2023-07-01 10:00:00',
                    twoFactorAuth: false,
                    accountLocked: false,
                    loginFailureCount: 0,
                    passwordExpiry: '2025-07-01',
                    permissions: ['content:publish'],
                    importSource: 'manual',
